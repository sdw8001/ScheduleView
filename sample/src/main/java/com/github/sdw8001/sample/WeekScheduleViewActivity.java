...
import com.github.sdw8001.scheduleview.fragment.WeekScheduleFragment;
...
public class WeekScheduleViewActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_weekscheduleview);
        ...
        if (WeekScheduleFragment.getInstance() == null)
            weekScheduleFragment = new WeekScheduleFragment();
        else
            weekScheduleFragment = WeekScheduleFragment.getInstance();

        getSupportFragmentManager().beginTransaction().replace(R.id.container, weekScheduleFragment).commit();
        getSupportFragmentManager().executePendingTransactions();

        weekScheduleFragment.setNumberOfVisibleDays(20);
        weekScheduleFragment.setScheduleLoadListener(this);
        weekScheduleFragment.setEventDrawListener(this);
        weekScheduleFragment.setOnEventClickListener(this);
        weekScheduleFragment.setEventLongPressListener(this);
        weekScheduleFragment.setEmptyViewClickListener(this);
        weekScheduleFragment.setGroupHeaderClickListener(this);
        weekScheduleFragment.setFloatingActionButton(fab);
        ...
        weekScheduleFragment.setGroupHeaderItems(headers);
        weekScheduleFragment.setViewMode(ScheduleView.VIEW_CHILD, false);
        weekScheduleFragment.notifyDatasetChanged();
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (id) {
            case R.id.action_doctor:
                if (weekScheduleFragment != null && weekScheduleFragment.getViewMode() != ScheduleView.VIEW_PARENT)
                    weekScheduleFragment.setViewMode(ScheduleView.VIEW_PARENT, true);
                return true;

            case R.id.action_chair:
                if (weekScheduleFragment != null && weekScheduleFragment.getViewMode() != ScheduleView.VIEW_CHILD)
                    weekScheduleFragment.setViewMode(ScheduleView.VIEW_CHILD, true);
                return true;
        }
...
*/
    ...
    public void onGroupHeaderClicked(GroupHeader groupHeader) {
        if (groupHeader != null) {
//            if (weekScheduleFragment.getFixedGroupHeader() == null) {
//                this.weekScheduleFragment.setFixedGroupHeader(groupHeader);
//            } else {
//                this.weekScheduleFragment.setFixedGroupHeader(null);
//            }
//            this.weekScheduleFragment.notifyDatasetChanged();
